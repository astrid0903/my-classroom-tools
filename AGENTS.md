...
## 對話開始時請先讀
進度與最近更動都在 Obsidian：`OB/10-專案工作筆記/my-classroom-tools/my-classroom-tools 工作筆記.md`
...
- 📘 Obsidian 駕駛艙：`OB/10-專案工作筆記/my-classroom-tools/my-classroom-tools 工作筆記.md`
...
2. 找到工作目錄（當前 cwd）和對應的 Obsidian 工作筆記（`OB/10-專案工作筆記/my-classroom-tools/my-classroom-tools 工作筆記.md`）
3. 更新 Obsidian 工作筆記：
   - 「⏯️ 上次做到哪」段：最後動作、完成檔案、對話脈絡
   - 「🗓️ 最近更動紀錄」表格加一行：2026-05-10 + 摘要 + ✅✅✅
   - 「🕳️ 踩坑筆記」（若有新坑）
4. Git commit + push：
   ```bash
