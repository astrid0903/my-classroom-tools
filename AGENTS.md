...
2. 找到工作目錄（當前 cwd）和對應的 Obsidian 工作筆記（`OB/10-專案工作筆記/W08-05.教學播放台-OB/W08-05.教學播放台-OB 工作筆記.md`）
3. 更新 Obsidian 工作筆記：
...
4. Git commit + push：
   ```bash
   cd "/Users/hsiaoyutsai/我的雲端硬碟 (gisele0903@gmail.com)/04.Work/08.Work_AI應用功能/W08-05.教學播放台"
...
## 工具清單
（之後加新工具時自動更新）
- Google Slides 教學播放台：`index.html` / `script.js` / `styles.css` / `styles-dark.css`
